...
#' utilizando a função interna \code{pg_get}. Em vez de inserir o endpoint na URL, utiliza-se
...
#'
#' @param id_plano_acao_dado_bancario Identificador do dado bancário do plano de ação (numérico).
#' @param id_agencia_conta Identificador da agência/conta (numérico).
#' @param codigo_banco_plano_acao_dado_bancario Código do banco (texto).
#' @param nome_banco_plano_acao_dado_bancario Nome do banco (texto).
#' @param numero_agencia_plano_acao_dado_bancario Número da agência (texto ou numérico).
#' @param dv_agencia_plano_acao_dado_bancario Dígito verificador da agência (texto).
#' @param numero_conta_plano_acao_dado_bancario Número da conta (texto ou numérico).
#' @param dv_conta_plano_acao_dado_bancario Dígito verificador da conta (texto).
#' @param situacao_conta_plano_acao_dado_bancario Situação da conta (texto).
#' @param data_abertura_conta_plano_acao_dado_bancario Data de abertura da conta (formato YYYY-MM-DD).
#' @param nome_programa_agil_conta_plano_acao_dado_bancario Nome do programa ágil associado à conta (texto).
#' @param saldo_final_conta_plano_acao_dado_bancario Saldo final da conta (numérico).
#' @param id_plano_acao Identificador do plano de ação ao qual o dado bancário está vinculado (numérico).
#'

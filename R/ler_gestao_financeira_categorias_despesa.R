...
#' @param id_nivel_pai_categoria_despesa_gestao_financeira Identificador do nível pai da categoria de despesa (numérico).
#' @param nome_nivel_atual_categoria_despesa_gestao_financeira Nome do nível atual da categoria de despesa (texto).
#' @param nivel_atual_categoria_despesa_gestao_financeira Nível atual da categoria de despesa (texto ou numérico).
#' @param nome_completo_niveis_categoria_despesa_gestao_financeira Nome completo dos níveis da categoria de despesa (texto).

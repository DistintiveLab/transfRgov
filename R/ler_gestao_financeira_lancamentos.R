...
#'
#' @param id_lancamento_gestao_financeira Identificador do lançamento (numérico).
#' @param origem_solicitacao_gestao_financeira Origem da solicitação (texto).
#' @param descricao_origem_solicitacao_gestao_financeira Descrição da origem da solicitação (texto).
#' @param cnpj_ente_solicitante_gestao_financeira CNPJ do ente solicitante (texto).
#' @param nome_ente_solicitante_gestao_financeira Nome do ente solicitante (texto).
#' @param nome_personalizado_ente_solicitante_gestao_financeira Nome personalizado do ente solicitante (texto).
#' @param codigo_programa_agil_ente_solicitante_gestao_financeira Código do programa ágil do ente solicitante (texto).
#' @param codigo_banco_gestao_financeira Código do banco (texto ou numérico).
#' @param codigo_agencia_gestao_financeira Código da agência (texto ou numérico).
#' @param dv_agencia_gestao_financeira Dígito verificador da agência (texto).
#' @param codigo_conta_gestao_financeira Código da conta (texto ou numérico).
#' @param dv_conta_gestao_financeira Dígito verificador da conta (texto).
#' @param tipo_operacao_gestao_financeira Tipo de operação (texto).
#' @param descricao_tipo_operacao_gestao_financeira Descrição do tipo de operação (texto).
#' @param descricao_gestao_financeira Descrição da gestão financeira (texto).
#' @param data_lancamento_gestao_financeira Data do lançamento (formato YYYY-MM-DD).
